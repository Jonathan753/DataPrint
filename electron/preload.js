...
contextBridge.exposeInMainWorld("receipt", {
    ...
    generatePdf: (receiptId) => ipcRenderer.invoke("receipt:generate-pdf", receiptId),
    generatePdfFast: (client, data) => ipcRenderer.invoke("receipt:generate-pdf-fast", client, data),
});
