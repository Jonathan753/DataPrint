...
// // Garante que o app já iniciou (app.getPath só funciona depois do ready)
// const userDataPath = app?.getPath("userData") || path.resolve(__dirname);
// const dbFolder = path.join(userDataPath, "DataPrint");
// const dbPath = path.join(dbFolder, "storage.db");
...
// // Cria (ou abre) o banco no diretório do usuário
// const db = new Database(dbPath);
