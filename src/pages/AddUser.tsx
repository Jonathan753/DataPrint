        ...
        <>
            ...
            <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <Input gridClass="md:col-span-1" onChange={handleChange} value={form.cnpj_cpf} mask="cpf-cnpj" label="CPF/CNPJ" id="cnpj_cpf" name="cnpj_cpf" type="text" placeholder="00.000.000/0001-00" />
